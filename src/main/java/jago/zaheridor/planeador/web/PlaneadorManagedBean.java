...
public class PlaneadorManagedBean {
    ...
    private final String ARCHIVO = "/Users/zaheridor/Documents/STUDY/proyecto_planeador/planeador/src/main/resources/archivo.csv";
    ...
    public String cargar(){
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(ARCHIVO)))
        {
            ...
            while ((line = br.readLine()) != null) {
                logger.log(Level.INFO, "ruta: "+line);
            }
